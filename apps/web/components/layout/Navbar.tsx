      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="hidden rounded-full border border-[var(--surface-border)] bg-[var(--surface-muted)] px-3 py-1.5 text-xs font-semibold text-[var(--text-primary)] transition hover:border-[var(--surface-border-strong)] hover:bg-white/10 md:inline-flex"
            title="Ctrl/Cmd + K"
          >
            Ctrl+K
          </button>
