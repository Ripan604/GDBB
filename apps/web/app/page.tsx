...
const CHAPTERS: HomeChapter[] = [
  ...
  },
  {
    ...
    title: 'Explore patent claims and coverage boundaries.',
    summary:
      'Review claim scope, novelty risk, and cross-domain coverage to understand what parts of GDBB are strategically protectable.',
    facts: ['Claim tree', 'Risk overlays', 'Coverage map'],
    route: '/patents',
  },
  {
    id: 'topic-compare',
