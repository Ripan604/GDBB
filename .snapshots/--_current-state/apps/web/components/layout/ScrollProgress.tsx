...
export function ScrollProgress() {
  ...
  return (
    <div className="fixed left-0 right-0 top-0 z-[60] h-[3px]" style={{ background: 'var(--surface-muted)' }}>
      <div
        className="h-full transition-[width] duration-150"
        style={{
          width: `${progress * 100}%`,
          background: 'linear-gradient(90deg, var(--accent-neural) 0%, #8acff0 50%, var(--accent-sigma) 100%)',
