    ...
    <section className="space-y-6 pb-8">
      ...
      <div className="grid gap-5 lg:grid-cols-[1.3fr_0.8fr]">
        <div className="glass-panel-strong rounded-2xl p-4">
          <div className="surface-muted mb-3 max-h-[56vh] space-y-3 overflow-auto rounded-xl p-3">
            {messages.length === 0 && (
            ...
            {messages.map((m, i) => (
              <div key={`${m.role}-${i}`}>
                <p className="text-xs uppercase tracking-[0.14em] text-[var(--text-secondary)]">{m.role}</p>
